...
function school_scripts() {
	...
	wp_enqueue_style( 'school-main', get_stylesheet_uri() . '/style-main.css', array(), _S_VERSION );
	...
	wp_enqueue_script( 'school-main', get_template_directory_uri() . '/js/app.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'jquery' , 'https://code.jquery.com/jquery-3.6.0.js' , array('jquery'), _S_VERSION , true );
